...
from shows.models import Show, PerformanceSchedule
...
class Notice(models.Model):
    ...
    performance_schedule = models.ForeignKey(PerformanceSchedule, null=True, blank=True, on_delete=models.SET_NULL) #공연 운영시간
